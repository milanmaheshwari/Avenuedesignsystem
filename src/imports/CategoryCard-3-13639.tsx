import svgPaths from "./svg-dt2ofmxrvd";
import imgImage93 from "figma:asset/e11cd373cec97f96673d91e50e2ae9765b8ab20d.png";
    ...
    <div className="max-w-[246.40000915527344px] relative shrink-0 size-[24px]" data-name="Icon">
      <div className="absolute inset-0" style={{ "--stroke-0": "rgba(250, 250, 250, 1)" } as React.CSSProperties}>
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
          <g id="Icon">
            <rect fill="url(#paint0_linear_3_13646)" height="24" rx="8" width="24" />
            <rect height="23" rx="7.5" stroke="var(--stroke-0, #FAFAFA)" strokeOpacity="0.1" width="23" x="0.5" y="0.5" />
            <path d={svgPaths.p26a3b780} id="Vector" stroke="var(--stroke-0, #FFF7ED)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_13646" x1="3.9" x2="14.1" y1="-1.8" y2="27.9">
...
function Text() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="flex flex-col font-['Satoshi:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#fff7ed] text-[16px] tracking-[-0.32px] w-full">
...
function Subtitle() {
  return (
    <div className="content-stretch flex items-start overflow-clip relative shrink-0 w-full" data-name="Subtitle">
      <div className="basis-0 flex flex-col font-['Satoshi:Regular',sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#fff7ed] text-[13px]">
        <p className="leading-[18px]">Find matches and tournaments near you</p>
      </div>
    </div>
  );
}
...
function Container() {
  return (
    <div className="h-[240px] overflow-clip relative rounded-[12px] shadow-[0px_0px_20px_5px_rgba(234,88,12,0.05)] shrink-0 w-[156px]" data-name="Container" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\\'0 0 156 240\\\' xmlns=\\\'http://www.w3.org/2000/svg\\\' preserveAspectRatio=\\\'none\\\'><rect x=\\\'0\\\' y=\\\'0\\\' height=\\\'100%\\\' width=\\\'100%\\\' fill=\\\'url(%23grad)\\\' opacity=\\\'0.6000000238418579\\\'/><defs><radialGradient id=\\\'grad\\\' gradientUnits=\\\'userSpaceOnUse\\\' cx=\\\'0\\\' cy=\\\'0\\\' r=\\\'10\\\' gradientTransform=\\\'matrix(-7.8 3.2587e-13 4.6388e-7 -22.239 78 120)\\\'><stop stop-color=\\\'rgba(194,65,12,1)\\\' offset=\\\'0\\\'/><stop stop-color=\\\'rgba(131,43,10,1)\\\' offset=\\\'0.5\\\'/><stop stop-color=\\\'rgba(99,31,8,1)\\\' offset=\\\'0.75\\\'/><stop stop-color=\\\'rgba(67,20,7,1)\\\' offset=\\\'1\\\'/></radialGradient></defs></svg>')" }}>
      <Image />
      <Content />
      <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_1px_0px_0px_rgba(234,88,12,0.05),inset_0px_0px_0px_1px_rgba(250,250,250,0.05)]" />
    </div>
  );
}
