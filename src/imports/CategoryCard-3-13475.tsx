import svgPaths from "./svg-jrdz7f77xb";
    ...
    <div className="max-w-[308px] relative shrink-0 size-[40px]" data-name="Icon">
      <div className="absolute inset-0" style={{ "--stroke-0": "rgba(250, 250, 250, 1)" } as React.CSSProperties}>
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
          <g id="Icon">
            <rect fill="url(#paint0_linear_3_13483)" height="40" rx="12" width="40" />
          ...
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_13483" x1="6.5" x2="23.5" y1="-3" y2="46.5">
