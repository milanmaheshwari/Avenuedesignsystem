import svgPaths from "./svg-ec312nelgo";
    ...
    <div className="max-w-[308px] relative shrink-0 size-[40px]" data-name="Icon">
      <div className="absolute inset-0" style={{ "--stroke-0": "rgba(250, 250, 250, 1)" } as React.CSSProperties}>
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
          <g id="Icon">
            <rect fill="url(#paint0_linear_3_13486)" height="40" rx="12" width="40" />
            <rect height="39" rx="11.5" stroke="var(--stroke-0, #FAFAFA)" strokeOpacity="0.1" width="39" x="0.5" y="0.5" />
            <path d={svgPaths.p77ccd40} id="Vector" stroke="var(--stroke-0, #FDF8F6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_13486" x1="6.5" x2="23.5" y1="-3" y2="46.5">
...
function Text() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="flex flex-col font-['Satoshi:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#fdf8f6] text-[24px] tracking-[-0.48px] w-full">
        <p className="leading-[28px]">Coffee Parties</p>
      </div>
    </div>
  );
}
...
function Subtitle() {
  return (
    <div className="content-stretch flex items-start overflow-clip relative shrink-0 w-full" data-name="Subtitle">
      <div className="basis-0 flex flex-col font-['Satoshi:Regular',sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#fdf8f6] text-[16px]">
        <p className="leading-[22px]">{`Taste brews and enjoy the company `}</p>
      </div>
    </div>
  );
}
