            ...
            <div className="flex items-center justify-between py-6 w-full relative">
              ...
              <div className="flex gap-6 items-center">
                ...
                <button className="flex gap-1 items-center px-0 py-1 rounded-[999px] text-card-foreground hover:opacity-80 transition-opacity">
                  <span style={{ fontFamily: typography.fontFamily.primary, fontWeight: typography.fontWeight.medium }}>New York</span>
                  <ChevronIcon />
                </button>
              </div>
              ...
              <div className="flex gap-1 items-center">
                ...
                <nav className="flex items-center px-2 py-[9px] rounded-[999px]">
                  <a href="#" className="px-3 text-card-foreground hover:opacity-80 transition-opacity" style={{ fontFamily: typography.fontFamily.primary, fontWeight: typography.fontWeight.medium }}>Find Events</a>
                  <a href="#" className="px-3 text-card-foreground hover:opacity-80 transition-opacity" style={{ fontFamily: typography.fontFamily.primary, fontWeight: typography.fontWeight.medium }}>Create Event</a>
                  <a href="#" className="px-3 text-card-foreground hover:opacity-80 transition-opacity" style={{ fontFamily: typography.fontFamily.primary, fontWeight: typography.fontWeight.medium }}>My Events</a>
                </nav>
                ...
                >
                  <span className="text-foreground" style={{ fontFamily: typography.fontFamily.primary, fontWeight: typography.fontWeight.bold }}>Sign Up</span>
                  <ArrowIcon />
                ...
                <nav className="flex flex-col items-start pb-3 pt-2 w-full">
                  <a href="#" className="w-full rounded-[20px] hover:bg-[rgba(250,250,250,0.05)] transition-colors">
                    <div className="flex items-center px-3 py-[13px]">
                      <span className="text-foreground" style={{ fontFamily: typography.fontFamily.primary }}>Find Events</span>
                    </div>
                  </a>
                  <a href="#" className="w-full rounded-[20px] hover:bg-[rgba(250,250,250,0.05)] transition-colors">
                    <div className="flex items-center px-3 py-[13px]">
                      <span className="text-foreground" style={{ fontFamily: typography.fontFamily.primary }}>Create Event</span>
                    </div>
                  </a>
                  <a href="#" className="w-full rounded-[20px] hover:bg-[rgba(250,250,250,0.05)] transition-colors">
                    <div className="flex items-center px-3 py-[13px]">
                      <span className="text-foreground" style={{ fontFamily: typography.fontFamily.primary }}>My Events</span>
                    </div>
                  </a>
                  <a href="#" className="w-full rounded-[20px] hover:bg-[rgba(250,250,250,0.05)] transition-colors">
                    <div className="flex items-center px-3 py-[13px]">
                      <span className="text-foreground" style={{ fontFamily: typography.fontFamily.primary }}>Profile</span>
                    </div>
                  </a>
                </nav>
              </>
